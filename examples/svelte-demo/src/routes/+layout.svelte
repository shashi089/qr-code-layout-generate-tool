...
<div class="min-h-screen bg-gray-50">
	{#if !isDesigner}
		<div class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-40 backdrop-blur-lg bg-white/95">
			<div class="max-w-7xl mx-auto px-8">
				<div class="flex items-center justify-between py-4">
					...
					<nav class="flex gap-2 bg-gray-100 p-1.5 rounded-xl">
						<a
							href="/"
							class={`flex items-center gap-2 px-4 py-2 font-semibold transition-all duration-200 rounded-lg ${pathname === '/'
						...
						<a
							href="/labels"
							class={`flex items-center gap-2 px-4 py-2 font-semibold transition-all duration-200 rounded-lg ${pathname.startsWith('/labels')
								? 'bg-white text-teal-600 shadow-sm'
								: 'text-gray-600 hover:text-gray-900 hover:bg-white/50'
								}`}
						>
						...
						<a
							href="/employees"
							class={`flex items-center gap-2 px-5 py-2.5 font-semibold transition-all duration-200 rounded-lg ${pathname.startsWith('/employees')
						...
						<a
							href="/machines"
							class={`flex items-center gap-2 px-4 py-2 font-semibold transition-all duration-200 rounded-lg ${pathname.startsWith('/machines')
								? 'bg-white text-teal-600 shadow-sm'
								: 'text-gray-600 hover:text-gray-900 hover:bg-white/50'
								}`}
						>
						...
						<a
							href="/storage"
							class={`flex items-center gap-2 px-4 py-2 font-semibold transition-all duration-200 rounded-lg ${pathname.startsWith('/storage')
								? 'bg-white text-teal-600 shadow-sm'
								: 'text-gray-600 hover:text-gray-900 hover:bg-white/50'
								}`}
						>
